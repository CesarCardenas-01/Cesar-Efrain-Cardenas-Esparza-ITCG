    ...
    case 3:      
      ...
      if (reply != null) {
         if (reply.getPerformative() == ACLMessage.INFORM) {
            ...
            JOptionPane.showMessageDialog(null, "Se realizo la compra de: "+bookTitle+", al agente "+reply.getSender().getLocalName()+" a un precio de "+bestPrice, "Compra Realizada", JOptionPane.INFORMATION_MESSAGE);
